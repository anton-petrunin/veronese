...
Such embeddings were discovered by Michael Gromov \cite[2.A]{gromov3}, \cite[1.1.A]{gromov2}.
...
Suppose that curvature of $\gamma_1$ is at least the curvature of $\gamma_2$ at any time moment,
and the curve
...
We can assume \( r = \tfrac{1}{\sqrt{3}} \), the circumradius of an equilateral triangle with unit side.
...
If $n\geqslant 3$, then each space \( \RP^n \), \( \CP^n \), and \( \HP^n \) contains four points at a distance \( \tfrac{\pi}{2} \) from one another.
